...
export default function ClassEditForm({ post }: ClassEditFormProps) {
  ...
  async function save(status: "draft" | "published") {
    ...
    try {
      ...
      if (updated.slug !== post.slug) {
        router.replace(`/class/${updated.slug}/edit`);
      }
    } catch {
      toast.error("儲存失敗");
    } finally {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="簡短描述課程內容，將顯示為 TL;DR 摘要與 meta description（最多 150 字）"
