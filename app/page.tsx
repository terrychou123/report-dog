...
export const metadata: Metadata = {
  ...
  description:
    "報告汪是專為長照機構設計的 AI 文書管理系統，支援居服機構、日照中心、醫院護理部、護理之家四大族群。透過智慧標籤分類、拖曳排序、AI 輔助撰寫，快速整理日誌、評鑑報告與個案記錄。多職類協作，評鑑備審文件一鍵彙整，不再臨時找不到報告。立即免費試用。",
  keywords: ["長照報告管理", "居家服務機構", "日照中心文書", "護理之家文書", "醫院護理部", "AI報告輔助", "定期報告", "社工報告", "個管師"],
  alternates: { canonical: "/" },
  openGraph: {
    title: "報告汪｜長照機構 AI 文書管理・報告生成・評鑑備審，居服・日照・護理之家・醫院護理部適用",
    description:
      "報告汪是專為長照機構設計的 AI 文書管理系統，支援居服機構、日照中心、醫院護理部、護理之家四大族群。透過智慧標籤分類、拖曳排序、AI 輔助撰寫，快速整理日誌、評鑑報告與個案記錄。多職類協作，評鑑備審文件一鍵彙整，不再臨時找不到報告。立即免費試用。",
  },
  twitter: {
