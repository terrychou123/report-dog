...
export const metadata: Metadata = {
  title: { absolute: "報告汪｜長照機構 AI 文書管理，評鑑備審・報告生成一站搞定" },
  description:
    "專為長照與社福機構設計的 AI 文書管理系統，智慧標籤分類、AI 輔助撰寫，評鑑備審文件一鍵彙整不遺漏。居服・日照・護理之家・醫院護理部・身障機構適用，立即免費試用。",
  keywords: ["長照報告管理", "居家服務機構", "日照中心文書", "護理之家文書", "醫院護理部", "身心障礙福利機構", "AI報告輔助", "定期報告", "社工報告", "個管師", "追蹤報告", "逾期提醒"],
  alternates: { canonical: "/" },
  openGraph: {
    title: "報告汪｜長照機構 AI 文書管理，評鑑備審・報告生成一站搞定",
    description:
      "專為長照與社福機構設計的 AI 文書管理系統，智慧標籤分類、AI 輔助撰寫，評鑑備審文件一鍵彙整不遺漏。居服・日照・護理之家・醫院護理部・身障機構適用，立即免費試用。",
  },
  twitter: {
