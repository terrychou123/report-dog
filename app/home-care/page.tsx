...
export const metadata: Metadata = {
  title: "居服機構 AI 文書管理｜AI 日誌撰寫・評鑑查核零補件｜報告汪",
  description:
    "報告汪專為居服機構打造，督導依服員建立標籤分類、AI 輔助日誌撰寫省時省力，評鑑查核零補件、文件不再散落。居服員・督導・主任同平台管理，支援行動裝置隨時記錄。立即免費試用。",
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="flex flex-col items-center text-center py-24 px-6 bg-gradient-to-b from-background to-muted/30">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <StartButton source="home-care-hero">立即開始 — 免費</StartButton>
          <TrialButton source="home-care-hero">免費試用（無需註冊）</TrialButton>
        </div>
      </section>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <StartButton source="home-care-bottom">免費開始使用</StartButton>
      </section>
