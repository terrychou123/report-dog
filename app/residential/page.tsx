...
export const metadata: Metadata = {
  title: "住宿型長照機構 AI 文書管理｜多職種協作・評鑑備審｜報告汪",
  description:
    "報告汪專為住宿型長照機構設計，護理師・照服員・社工・營養師同平台協作，依職類標籤分區管理、AI 輔助照護紀錄，住民文件不遺漏，評鑑備審自動彙整。立即免費試用。",
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="flex flex-col items-center text-center py-24 px-6 bg-gradient-to-b from-background to-muted/30">
        ...
        <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight max-w-3xl mb-6 leading-tight">
          住宿型長照機構文書管理系統｜<span className="text-primary">多職種同平台協作</span>
        </h1>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">住宿型長照機構文書管理這樣做：依職類標籤分區，24小時住民照護不遺漏</h2>
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              從多職類標籤分區到跨職類月報，從住民照護計畫追蹤到 AI 輔助紀錄，每個功能都以住宿型長照機構工作流程為中心。
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            ...
            <Card className="border-primary/40 md:col-span-3">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mt-3">
                  ...
                  <br /><br />
                  用了<span className="text-foreground font-medium">報告汪</span>之後，我們依<span className="text-foreground font-medium">撰寫頻率</span>設三層標籤：「每班執行」、「每日一次」、「每週」，每位護理師交班後打開系統，<span className="text-foreground font-medium">拖曳排序</span>當班任務，不會再遺漏壓瘡翻身記錄或夜班的血壓量測。評鑑委員說我們是他今年巡訪中<span className="text-foreground font-medium">文書最完整</span>的住宿型長照機構。
                </p>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="text-amber-500 text-sm mt-3">★★★★★</div>
                <p className="text-sm text-muted-foreground leading-relaxed mt-3">
                  住宿型長照機構的社工要同時處理個案入住評估、家屬溝通紀錄、節慶團體活動（含照片）和申訴案件統計，每種文件格式和送審週期都不同，以前光是管這些就快搞混。
                  <br /><br />
