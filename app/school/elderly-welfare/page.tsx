...
export const metadata: Metadata = {
  title: "115年老人福利機構評鑑指標｜77 項 6 大區塊＋免費檢核表",
  description:
    "115 年老人福利機構評鑑 77 項基準怎麼準備？6 大區塊（經營管理、專業照護、安全環境、住民權益等）重點整理＋免費 Excel 檢核表下載，3 步驟備評不踩雷。",
  keywords: [
    "老人福利機構評鑑",
    "老人福利機構評鑑指標",
    "115年度老人福利機構",
  ...
  openGraph: {
    title: "115年老人福利機構評鑑指標｜77 項 6 大區塊＋免費檢核表",
    description: "115 年老人福利機構評鑑 77 項基準，6 大區塊（經營管理、專業照護、安全環境、住民權益等）重點整理，附免費 Excel 檢核表下載。",
  ...
  return (
    <>
      ...
      <div className="mt-10 rounded-xl border border-dashed border-primary/30 bg-muted/50 p-5 text-center">
        ...
        <SchoolDownloadButton catalogSlug="elderly-welfare" />
      </div>
