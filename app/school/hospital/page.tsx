...
export const metadata: Metadata = {
  // SEO 優化 2026-06-22：原 title「逐條解析」太學術，0% CTR（199 曝光）
  // 改為聚焦實用工具：必要條文清單 + 免費檢核表，對齊使用者「怎麼準備」意圖
  title: "115年醫院評鑑必要條文清單｜20項不可失分基準＋免費檢核表",
  description:
    "115 年醫院評鑑 20 項必要條文（失分不通過）完整清單，124 條基準逐章標示重點，區域、地區醫院適用。附免費自我評估檢核表，幫助備評委員會系統化分工備審。",
  keywords: [
    "醫院評鑑",
    "115年度醫院評鑑基準",
    "醫院評鑑必要條文",
