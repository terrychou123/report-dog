...
export function ClassListFilter({ posts, categories }: ClassListFilterProps) {
  ...
  function handleCategoryChange(cat: string | null) {
    ...
    const qs = params.toString();
    router.push(qs ? `/class?${qs}` : "/class", { scroll: false });
  }
          ...
          {totalPages > 1 && (
            <div className="mt-16">
              ...
              <p className="text-center text-sm text-muted-foreground mt-3">
                第 {safePage} / {totalPages} 頁，共 {filtered.length} 個課程
              </p>
            </div>
          )}
        </>
