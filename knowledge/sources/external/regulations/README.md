...
├── ltc-institution-corporate-act.md  # 長照機構法人條例（法人設立、董事、財務）
├── ltc-institution-corporate-rules.md # 長照機構法人條例施行細則（申請文件、程序）
└── standards/
...
| `ltc-institution-corporate-act.md` | 全機構類型（住宿式特別相關） |
| `ltc-institution-corporate-rules.md` | 全機構類型（住宿式特別相關） |
