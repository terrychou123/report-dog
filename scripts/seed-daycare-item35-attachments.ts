/**
 * 將「緊急事故處理同意書」附件分頁
 * Append 到日照項目 35「意外或緊急事件處理情形」範本末端。
 *
 ...
 *
 * Run:
 *   npx dotenv-cli -e .env.local -- tsx scripts/seed-daycare-item35-attachments.ts
 */
...
const TARGET_ITEM_ID = 35;
const MAX_REVISIONS = 5;
const SEED_SCRIPT_USER_ID = "seed-script-item35-attachments";
