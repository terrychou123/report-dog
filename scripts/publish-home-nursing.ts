/**
 * 發布居家護理所評鑑系列文章（3 篇）
 * npx tsx --env-file=.env.local scripts/publish-home-nursing.ts
 */
...
const slugs = [
  "home-nursing-eval-prep-guide-2026",
  "home-nursing-eval-common-mistakes-2026",
  "home-nursing-self-eval-excel-guide-2026",
];
